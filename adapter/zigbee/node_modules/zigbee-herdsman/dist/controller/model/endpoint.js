...
class Endpoint extends zigbeeEntity_1.ZigbeeEntity {
    ...
    async readResponse(clusterKey, transactionSequenceNumber, attributes, options) {
        ...
        await this.zclCommand(cluster, "readRsp", payload, { direction: Zcl.Direction.SERVER_TO_CLIENT, disableDefaultResponse: true, ...options, transactionSequenceNumber }, attributes);
    }
