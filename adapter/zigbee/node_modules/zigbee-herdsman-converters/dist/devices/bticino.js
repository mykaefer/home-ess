...
exports.definitions = [
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, fz.on_off, fzLocal.K4003C_binary_input, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [tz.on_off, legrand_1.tzLegrand.led_mode, legrand_1.tzLegrand.identify],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster()],
    ...
    },
    {
        ...
        toZigbee: [legrand_1.tzLegrand.led_mode, legrand_1.tzLegrand.legrand_device_mode, legrand_1.tzLegrand.identify, tz.ballast_config],
        exposes: [
        ...
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster(), m.light({ configureReporting: true })],
    },
    {
