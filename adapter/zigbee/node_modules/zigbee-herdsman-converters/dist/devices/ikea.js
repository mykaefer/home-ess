...
exports.definitions = [
    ...
    },
    {
        ...
        extend: [
            (0, ikea_1.addCustomClusterManuSpecificIkeaUnknown)(),
            (0, ikea_1.addIkeaGenScenesCluster)(),
            ...
            (0, ikea_1.ikeaBattery)(),
            ikea_1.ikeaModernExtend.handleAppVersionReadRequest(),
        ],
        ota: true,
    },
    {
    ...
    },
    {
        ...
        extend: [
            (0, ikea_1.addCustomClusterTradfriButton)(),
    ...
    },
    {
        ...
        extend: [
            (0, ikea_1.addCustomClusterManuSpecificIkeaUnknown)(),
            (0, ikea_1.addCustomClusterManuSpecificIkeaMotionSensor)(),
            m.occupancy(),
            m.illuminance(),
            m.identify({ isSleepy: true }),
            m.battery({ voltage: true, voltageReporting: true }),
            (0, ikea_1.ikeaMotionSensorTriggerMode)(),
            (0, ikea_1.ikeaMotionSensorOnDuration)(),
        ],
        ota: true,
    },
    {
