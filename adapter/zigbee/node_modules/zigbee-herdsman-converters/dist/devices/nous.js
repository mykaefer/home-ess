...
exports.definitions = [
    ...
    },
    {
        ...
        exposes: [
            te
                .switch()
                .withDescription("On/off state of the circuit (WARNING: It may automatically switch ON after a fault is cleared. See Reclosing option)"),
            ...
            te
                .reclosing()
                .withDescription("Automatically attempt switching ON the circuit after it was turned OFF by a detected fault (WARNING: It seems this happens even when disabled)"),
            te.reclosing_delay(),
            te.reclosing_count(),
            te.energyPrepayment(),
            te.energyBalance(),
