    ...
    rd1p_rem_lite_ep2: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (Object.hasOwn(msg.data, rd1pREMLiteEP2Attribute)) {
                const value = msg.data[rd1pREMLiteEP2Attribute];
...
exports.definitions = [
    ...
    },
    {
        ...
        toZigbee: [],
        exposes: [
            e.action(Array.from({ length: 10 }, (_, i) => i + 1).flatMap((btn) => Object.values(kineticRFButtonMultiPressActions).map((state) => `button_${btn}_${state}_pressed`))),
        ],
    },
];
