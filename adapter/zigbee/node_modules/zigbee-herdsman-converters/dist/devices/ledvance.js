...
// the attributes.
const silenceDivisorReporting = {
    configure: [
        async (device, coordinatorEndpoint) => {
            try {
                await m.setupAttributes(device, coordinatorEndpoint, "haElectricalMeasurement", [
...
exports.definitions = [
    ...
    },
    {
        ...
        extend: [(0, ledvance_1.ledvanceOnOff)(), m.electricityMeter(), silenceDivisorReporting],
    },
    {
