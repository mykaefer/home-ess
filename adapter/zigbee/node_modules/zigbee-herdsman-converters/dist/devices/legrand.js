...
exports.definitions = [
    ...
    },
    {
        ...
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster(), m.onOff()],
        ota: true,
        fromZigbee: [fz.identify, fz.electrical_measurement, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [legrand_1.tzLegrand.legrand_device_mode, legrand_1.tzLegrand.identify, tz.electrical_measurement_power],
        exposes: [
    ...
    },
    {
        ...
        extend: [
            legrand_1.legrandExtend.addLegrandDevicesCluster(),
            legrand_1.legrandExtend.addLegrandDevices3Cluster(),
            m.onOff(),
            m.electricityMeter({ cluster: "electrical", voltage: false, current: false }),
        ],
        ota: true,
        fromZigbee: [fz.identify, legrand_1.fzLegrand.cluster_fc01, fz.electrical_measurement],
        toZigbee: [legrand_1.tzLegrand.legrand_device_mode, legrand_1.tzLegrand.identify, legrand_1.tzLegrand.auto_mode, tz.electrical_measurement_power],
        exposes: [
            e
                .enum("device_mode", ea.ALL, ["switch", "auto"])
    ...
    },
    {
        ...
        toZigbee: [legrand_1.tzLegrand.identify, tz.electrical_measurement_power],
        exposes: [e.power().withAccess(ea.STATE_GET), legrand_1.eLegrand.identify()],
        version: "0.0.1",
        configure: async (device, coordinatorEndpoint) => {
            const endpoint = device.getEndpoint(1);
            ...
            await reporting.readEletricalMeasurementMultiplierDivisors(endpoint);
            await reporting.activePower(endpoint);
            await endpoint.write("manuSpecificLegrandDevices", { deviceMode: 3 }, legrand_1.legrandOptions);
            await endpoint.read("manuSpecificLegrandDevices", [0x0000], legrand_1.legrandOptions);
        },
    },
    {
        ...
        fromZigbee: [
            ...
            fz.battery,
            legrand_1.fzLegrand.binary_input_moving,
            legrand_1.fzLegrand.stop_poll_on_checkin,
        ],
        toZigbee: [],
    ...
    },
    {
        ...
        extend: [
            legrand_1.legrandExtend.addLegrandDevicesCluster(),
            legrand_1.legrandExtend.addLegrandClosuresWindowCovering(),
            tuya.clusters.addTuyaClosuresWindowCoveringCluster(),
        ],
        fromZigbee: [fz.cover_position_tilt, fz.identify, legrand_1.fzLegrand.cluster_fc01, legrand_1.fzLegrand.calibration_mode(false), legrand_1.fzLegrand.command_cover],
    ...
    },
    {
        ...
        fromZigbee: [fz.identify, legrand_1.fzLegrand.binary_input_moving, fz.cover_position_tilt, legrand_1.fzLegrand.cluster_fc01],
    ...
    },
    {
        ...
        fromZigbee: [fz.cover_position_tilt, fz.identify, legrand_1.fzLegrand.cluster_fc01, legrand_1.fzLegrand.calibration_mode(true), legrand_1.fzLegrand.command_cover],
    ...
    },
    {
        ...
        toZigbee: [legrand_1.tzLegrand.led_mode, legrand_1.tzLegrand.legrand_device_mode, legrand_1.tzLegrand.identify, tz.ballast_config, tz.level_config],
        exposes: [
        ...
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster(), m.light({ configureReporting: true, levelConfig: { features: ["on_level"] } })],
        configure: async (device, coordinatorEndpoint) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [legrand_1.fzLegrand.scenes, legrand_1.fzLegrand.master_switch_center, fz.battery, legrand_1.fzLegrand.stop_poll_on_checkin],
        toZigbee: [],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster()],
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, fz.metering, fz.electrical_measurement, legrand_1.fzLegrand.power_alarm, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [legrand_1.tzLegrand.led_mode, tz.electrical_measurement_power, legrand_1.tzLegrand.power_alarm, legrand_1.tzLegrand.identify],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster(), legrand_1.legrandExtend.addLegrandHaElectricalMeasurement()],
        exposes: [
            e.power().withAccess(ea.STATE_GET),
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, fz.metering, fz.electrical_measurement, legrand_1.fzLegrand.power_alarm, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [legrand_1.tzLegrand.led_mode, legrand_1.tzLegrand.identify, tz.electrical_measurement_power, legrand_1.tzLegrand.power_alarm],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster(), legrand_1.legrandExtend.addLegrandHaElectricalMeasurement()],
        exposes: [
            e.power().withAccess(ea.STATE_GET),
            e.power_apparent(),
    ...
    },
    {
        ...
        ota: true,
        meta: { battery: { voltageToPercentage: { min: 2500, max: 3000 } } },
        fromZigbee: [legrand_1.fzLegrand.scenes, fz.battery, legrand_1.fzLegrand.master_switch_center],
        toZigbee: [],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster()],
        exposes: [e.battery(), e.action(["enter", "leave", "sleep", "wakeup", "center"])],
        configure: async (device, coordinatorEndpoint) => {
    ...
    },
    {
        ...
        ota: false,
        fromZigbee: [legrand_1.fzLegrand.greenpower],
        toZigbee: [],
        exposes: [
            e.action([
                "home_arrival",
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [legrand_1.fzLegrand.cluster_fc01, legrand_1.fzLegrand.pilot_wire_mode, fz.on_off, fz.electrical_measurement, fz.power_on_behavior],
        toZigbee: [legrand_1.tzLegrand.legrand_device_mode, legrand_1.tzLegrand.pilot_wire_mode, tz.on_off, tz.electrical_measurement_power, tz.power_on_behavior],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster(), legrand_1.legrandExtend.addLegrandDevices2Cluster()],
        exposes: [
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, legrand_1.fzLegrand.binary_input_on_off, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [legrand_1.tzLegrand.identify, legrand_1.tzLegrand.led_mode],
        exposes: [legrand_1.eLegrand.ledInDark(), legrand_1.eLegrand.ledIfOn()],
        extend: [
            legrand_1.legrandExtend.addLegrandDevicesCluster(),
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [fz.on_off, legrand_1.fzLegrand.binary_input_on_off, legrand_1.fzLegrand.cluster_fc01],
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, fz.lighting_ballast_configuration, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [tz.on_off, legrand_1.tzLegrand.led_mode, legrand_1.tzLegrand.legrand_device_mode, legrand_1.tzLegrand.identify, tz.ballast_config],
        exposes: [
            e.numeric("ballast_minimum_level", ea.ALL).withValueMin(1).withValueMax(254).withDescription("Specifies the minimum brightness value"),
            e.numeric("ballast_maximum_level", ea.ALL).withValueMin(1).withValueMax(254).withDescription("Specifies the maximum brightness value"),
            e.binary("device_mode", ea.ALL, "dimmer_on", "dimmer_off").withDescription("Allow the device to change brightness"),
    ...
    },
    {
        ...
        ota: true,
        meta: { battery: { voltageToPercentage: { min: 2500, max: 3000 } } },
        fromZigbee: [fz.battery, legrand_1.fzLegrand.scenes],
