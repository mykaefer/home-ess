...
async function ensureLumiIasEnrollment(endpoint, coordinatorEndpoint) {
    const coordinatorIeeeAddress = coordinatorEndpoint.deviceIeeeAddress;
    const isEnrolled = (state) => state.zoneState === 1 && state.iasCieAddr?.toLowerCase() === coordinatorIeeeAddress.toLowerCase();
...
exports.definitions = [
    ...
    },
    {
        ...
        exposes: [
            ...
            e
                ...
                .withDescription("Region definitions written through Zigbee2MQTT. " +
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.read("manuSpecificLumi", [0x00f7], { manufacturerCode: manufacturerCode }); // Read battery data; firmware 0.0.0_6542 does not push the 0x00F7 struct on its own
            ...
            await endpoint.configureReporting("manuSpecificLumi", [
                { attribute: { ID: 0x0142, type: zigbee_herdsman_1.Zcl.DataType.UINT8 }, minimumReportInterval: 0, maximumReportInterval: 3600, reportableChange: 1 },
                { attribute: { ID: 0x014d, type: zigbee_herdsman_1.Zcl.DataType.UINT8 }, minimumReportInterval: 0, maximumReportInterval: 3600, reportableChange: 1 },
            ], { manufacturerCode: manufacturerCode });
        },
        extend: [
            lumi.modernExtend.addManuSpecificLumiCluster(),
