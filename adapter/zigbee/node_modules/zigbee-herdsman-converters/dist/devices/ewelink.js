...
const ewelinkExtend = {
    ...
    addCustomClusterSiren: () => {
        return m.deviceAddCustomCluster("customEwelinkSiren", {
            name: "customEwelinkSiren",
            ID: 0xfc11,
            attributes: {
                alarmSoundMode: { name: "alarmSoundMode", ID: 0x2021, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                alarmSoundLevel: { name: "alarmSoundLevel", ID: 0x2022, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                alarmSoundTime: { name: "alarmSoundTime", ID: 0x2023, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
            },
            commands: {},
            commandsResponse: {},
        });
        ...
        const configure = [
            async (device, coordinatorEndpoint) => {
                try {
                    ...
                    logger_1.logger.warning(`eWeLink siren genOnOff bind/reporting failed, continuing without reporting: ${error}`, NS);
                }
            },
        ];
