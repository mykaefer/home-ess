...
exports.definitions = [
    ...
    },
    {
        ...
        extend: [
            ...
            bosch_1.boschThermostatExtend.operatingMode({ enableReporting: true }),
            bosch_1.boschThermostatExtend.rmThermostat({ weeklySchedule: true }),
            bosch_1.boschThermostatExtend.setpointChangeSource({ enableReporting: true }),
            bosch_1.boschThermostatExtend.humidity(),
    ...
    },
    {
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("boschEnergyDevice", {
                ...
                manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.ROBERT_BOSCH_GMBH,
                attributes: {
                    deviceMode: { name: "deviceMode", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.ENUM8, write: true, max: 0xff },
                    switchType: { name: "switchType", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.ENUM8, write: true, max: 0xff },
                    switchMode: { name: "switchMode", ID: 0x0031, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                    calibrationOpeningTime: { name: "calibrationOpeningTime", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
                    calibrationClosingTime: { name: "calibrationClosingTime", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
                    ...
                    calibrationButtonHoldTime: { name: "calibrationButtonHoldTime", ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                    ...
                    calibrationMotorStartDelay: { name: "calibrationMotorStartDelay", ID: 0x000f, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                    calibrationMotorReverseDirection: { name: "calibrationMotorReverseDirection", ID: 0x0032, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN, write: true },
                    motorState: { name: "motorState", ID: 0x0013, type: zigbee_herdsman_1.Zcl.DataType.ENUM8, write: true, max: 0xff },
                    ...
                    unknownAttributeOne: { name: "unknownAttributeOne", ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.BITMAP8, write: true },
                    ...
                    // change the value.
                    calibrationMotorEndPosition: { name: "calibrationMotorEndPosition", ID: 0x0021, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                    ...
                    // venetian blinds.
                    slatRotationDurationOne: { name: "slatRotationDurationOne", ID: 0x0010, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
                    slatRotationDurationTwo: { name: "slatRotationDurationTwo", ID: 0x0011, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
                    ...
                    unknownAttributeTwo: { name: "unknownAttributeTwo", ID: 0x002a, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN, write: true },
                },
                commands: {
