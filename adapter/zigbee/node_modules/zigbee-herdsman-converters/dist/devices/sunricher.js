...
const wally = __importStar(require("../devices/wally"));
...
const sunricherDaliEndpointIds = [1, 2, 3, 4, 5, 6, 7, 8];
...
const sunricherDaliColorTempRange = [150, 500];
...
function sunricherDaliIsEnabledEndpoint(endpoint) {
    return (sunricherDaliEndpointIds.includes(endpoint.ID) &&
        [sunricherDaliDimmableLightDeviceId, sunricherDaliColorTempLightDeviceId].includes(endpoint.deviceID));
}
function sunricherDaliIsColorTempEndpoint(endpoint) {
    return endpoint.deviceID === sunricherDaliColorTempLightDeviceId;
}
function sunricherDaliEndpointName(endpointID) {
    return `l${endpointID}`;
}
function sunricherDaliEnabledEndpoints(device) {
    return device.endpoints.filter(sunricherDaliIsEnabledEndpoint);
}
function sunricherDaliEndpointInfos(device) {
...
function sunricherDaliEndpoint(device) {
...
function sunricherDaliExposes(device) {
...
async function sunricherDaliReadInitialState(endpoint) {
...
function sunricherDaliController() {
    return {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            try {
                ...
                logger_1.logger.debug("Failed to setup occupancy reporting", NS);
            }
