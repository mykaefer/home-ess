...
exports.definitions = [
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            exports.fzLocal.awox_color_ctrl, // Always at the end to prioritize specific actions.
            exports.fzLocal.awox_level_ctrl,
            exports.fzLocal.awox_scenes_raw,
        ],
        toZigbee: [],
        exposes: [
            e.action([
