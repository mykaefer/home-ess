    ...
    tz: {
            ...
            convertSet: async (entity, key, value, meta) => {
                ...
                const waitUntilStopped = async () => {
                    ...
                    do {
                        ...
                        const response = await entity.read("closuresWindowCovering", [
                            "operationalStatus",
                        ]);
        ...
        configure_device_setup: {
            ...
            convertSet: async (entity, key, value, meta) => {
                ...
                (0, node_assert_1.default)(customCluster);
...
exports.definitions = [
    ...
    },
    {
        ...
        extend: [
            ...
            ubisys_1.ubisysModernExtend.pollCurrentSummDelivered(3),
            ubisys_1.ubisysModernExtend.operationalStatus(),
        ],
        configure: async (device, coordinatorEndpoint) => {
            ...
            const payload = reporting.payload("operationalStatus", 0, 65000, 0);
