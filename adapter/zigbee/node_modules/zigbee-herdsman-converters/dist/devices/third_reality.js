...
function conditionalPressure() {
    ...
    function deviceHasPressureCluster(device) {
        if (utils.isDummyDevice(device))
            return true; // docs generation: show it
...
function thirdRealitySoilMoisture() {
    const expose = e.soil_moisture().withAccess(ea.STATE_GET);
    const supportsNativeSoilMoisture = (device) => {
        if (utils.isDummyDevice(device))
            return true;
        return device.endpoints.some((endpoint) => endpoint.supportsInputCluster("msSoilMoisture"));
    };
    const getMeasurementEndpoint = (device) => {
        return (device.endpoints.find((endpoint) => endpoint.supportsInputCluster("msSoilMoisture")) ??
            device.endpoints.find((endpoint) => endpoint.supportsInputCluster("msRelativeHumidity")) ??
            device.endpoints[0]);
    };
    const hasMeasuredValue = (data) => {
        if (!("measuredValue" in data))
            return false;
...
exports.definitions = [
    ...
    },
    {
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("3rMotionV2SpecialCluster", {
                ...
                manufacturerCode: 0x1407,
                attributes: {
                    sensitivity: { name: "sensitivity", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, min: 1, max: 5 },
                    coolDownTime: { name: "coolDownTime", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true, min: 0, max: 3600 },
                    ledIndicator: { name: "ledIndicator", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, min: 0, max: 1 },
                },
                commands: {},
                commandsResponse: {},
            }),
    ...
    },
    {
        ...
        fromZigbee: [exports.fzLocal.itcmdr_clicks],
        ota: true,
        ...
        extend: [
            m.deviceAddCustomCluster("3rPlugGen2SpecialCluster", {
                ...
                attributes: {
                    ...
                    allowBind: { name: "allowBind", ID: 0x0020, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                    ledBrightness: { name: "ledBrightness", ID: 0x0010, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0x64 },
                },
                commands: {},
                commandsResponse: {},
            }),
    ...
    },
    {
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("genBasic", {
                ...
                attributes: {
                    ledBrightness: { name: "ledBrightness", ID: 0xff01, type: zigbee_herdsman_1.Zcl.DataType.UINT8, manufacturerCode: 0x1407, write: true, max: 0x64 },
                },
                commands: {},
                commandsResponse: {},
            }),
    ...
    },
    {
        ...
        extend: [
            m.deviceAddCustomCluster("3rVirationSpecialcluster", {
                ...
                manufacturerCode: 0x1233,
                attributes: {
                    coolDownTime: { name: "coolDownTime", ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true, max: 7200 },
                    xAxis: { name: "xAxis", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    yAxis: { name: "yAxis", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    zAxis: { name: "zAxis", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    xAngle: { name: "xAngle", ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    yAngle: { name: "yAngle", ID: 0x0006, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    zAngle: { name: "zAngle", ID: 0x0007, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                },
                commands: {},
                commandsResponse: {},
            }),
    ...
    },
    {
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("r3Specialcluster", {
                ...
                attributes: {
                    coldDownTime: { name: "coldDownTime", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true, max: 0xffff },
                    localRoutinTime: { name: "localRoutinTime", ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true, max: 0xffff },
                    luxThreshold: { name: "luxThreshold", ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true, max: 0xffff },
                },
                commands: {},
                commandsResponse: {},
            }),
        ...
        fromZigbee: [exports.fzLocal.thirdreality_private_motion_sensor, fz.ias_occupancy_alarm_1_report],
        exposes: [e.occupancy()],
    },
    {
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("3rColorLightSpecialCluster", {
                ...
                manufacturerCode: 0x1407,
                attributes: {
                    allowBind: { name: "allowBind", ID: 0x0020, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0x01 },
                },
                commands: {},
                commandsResponse: {},
            }),
    ...
    },
    {
        ...
        extend: [
            ...
            m.deviceAddCustomCluster("3r24gRadarcluster", {
                ...
                manufacturerCode: 0x1407,
                attributes: {
                    sensorSensitive: { name: "sensorSensitive", ID: 0x0060, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                    sensorCalibration: { name: "sensorCalibration", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
                },
                commands: {},
                commandsResponse: {},
            }),
