    ...
    },
    {
        ...
        exposes: [
            ...
            e
                ...
                .withValueMax(95)
                .withValueStep(1),
            Array.from({ length: 2 }, (_, i) => i + 1).reduce((composite, periodNum) => composite
                .withFeature(e
                ...
                .withValueStep(0.5)
                .withUnit("°C")
                .withDescription(`Target temperature of weekend period ${periodNum}`)), Array.from({ length: 6 }, (_, i) => i + 1).reduce((composite, periodNum) => composite
                .withFeature(e
                ...
                .withValueStep(0.5)
                .withUnit("°C")
                .withDescription(`Target temperature of workday period ${periodNum}`)), e
