...
class Base {
    ...
    withHomeAssistant(homeassistant) {
    ...
    withLevelConfig(features = [
        ...
        if (features.includes("on_transition_time")) {
            levelConfig = levelConfig.withFeature(new Numeric("on_transition_time", exports.access.ALL)
                ...
                .withDescription("Seconds taken to move the current level from the minimum level to the maximum level when an On command is received"));
        }
        if (features.includes("off_transition_time")) {
            levelConfig = levelConfig.withFeature(new Numeric("off_transition_time", exports.access.ALL)
                ...
                .withPreset("disabled", "disabled", "Use on_off_transition_time value")
                .withDescription("Seconds taken to move the current level from the maximum level to the minimum level when an Off command is received"));
        }
...
class Climate extends Base {
    ...
    withPiCoolingDemand(access = a.STATE) {
        this.addFeature(new Numeric("pi_cooling_demand", access)
    ...
    withSetpointChangeSource(access = a.STATE) {
        this.addFeature(new Enum("setpoint_change_source", access, Object.values(constants_1.thermostatSetpointChangeSource)).withDescription("Source of the current setpoint change"));
        return this;
    }
...
exports.options = {
    ...
    invert_cover: () => new Binary("invert_cover", exports.access.SET, true, false).withDescription("Inverts the cover position and state, false: open=100,close=0, true: open=0,close=100 (default false)."),
    ...
    homeassistant_climate_modes: () => new Enum("homeassistant_climate_modes", exports.access.SET, ["heat", "cool", "heat_cool"])
...
exports.presets = {
    ...
    consumer_connected: () => new Binary("consumer_connected", exports.access.STATE, true, false)
        ...
        .withCategory("diagnostic"),
    contact: () => new Binary("contact", exports.access.STATE, false, true)
    ...
    window_open: (access = a.STATE) => new Binary("window_open", access, true, false).withDescription("Indicates if window is open").withCategory("diagnostic"),
