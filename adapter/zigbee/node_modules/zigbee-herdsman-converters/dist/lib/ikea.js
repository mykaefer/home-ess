...
exports.ikeaModernExtend = exports.manufacturerOptions = void 0;
...
exports.ikeaBilresaDouble = ikeaBilresaDouble;
...
exports.addCustomClusterManuSpecificIkeaSmartPlug = addCustomClusterManuSpecificIkeaSmartPlug;
exports.addCustomClusterManuSpecificIkeaMotionSensor = addCustomClusterManuSpecificIkeaMotionSensor;
exports.ikeaMotionSensorTriggerMode = ikeaMotionSensorTriggerMode;
exports.ikeaMotionSensorOnDuration = ikeaMotionSensorOnDuration;
exports.addCustomClusterManuSpecificIkeaUnknown = addCustomClusterManuSpecificIkeaUnknown;
exports.addCustomClusterTradfriButton = addCustomClusterTradfriButton;
exports.addIkeaGenScenesCluster = addIkeaGenScenesCluster;
...
function ikeaBilresaDouble() {
    const exposes = [exposes_1.presets.action(["off_double", "on_double"])];
    const fromZigbee = [
        {
            cluster: "genScenes",
...
function addCustomClusterManuSpecificIkeaAirPurifier() {
    return m.deviceAddCustomCluster("manuSpecificIkeaAirPurifier", {
        ...
        attributes: {
            filterRunTime: { name: "filterRunTime", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
            replaceFilter: { name: "replaceFilter", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
            filterLifeTime: { name: "filterLifeTime", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
            controlPanelLight: { name: "controlPanelLight", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN, write: true },
            particulateMatter25Measurement: { name: "particulateMatter25Measurement", ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true, max: 0xffff },
            childLock: { name: "childLock", ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN, write: true },
            fanMode: { name: "fanMode", ID: 0x0006, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
            fanSpeed: { name: "fanSpeed", ID: 0x0007, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true, max: 0xff },
            deviceRunTime: { name: "deviceRunTime", ID: 0x0008, type: zigbee_herdsman_1.Zcl.DataType.UINT32, write: true, max: 0xffffffff },
        },
        commands: {},
        commandsResponse: {},
    });
...
function addCustomClusterManuSpecificIkeaVocIndexMeasurement() {
    return m.deviceAddCustomCluster("manuSpecificIkeaVocIndexMeasurement", {
        ...
        manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.IKEA_OF_SWEDEN,
        attributes: {
            measuredValue: { name: "measuredValue", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.SINGLE_PREC, write: true },
            measuredMinValue: { name: "measuredMinValue", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.SINGLE_PREC, write: true },
            measuredMaxValue: { name: "measuredMaxValue", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.SINGLE_PREC, write: true },
        },
        commands: {},
        commandsResponse: {},
    });
...
function addCustomClusterManuSpecificIkeaSmartPlug() {
    return m.deviceAddCustomCluster("manuSpecificIkeaSmartPlug", {
        ...
        manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.IKEA_OF_SWEDEN,
        attributes: {
            childLock: { name: "childLock", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN, write: true },
            ledEnable: { name: "ledEnable", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN, write: true },
        },
        commands: {},
        commandsResponse: {},
    });
}
function addCustomClusterManuSpecificIkeaMotionSensor() {
    return m.deviceAddCustomCluster("manuSpecificIkeaMotionSensor", {
        name: "manuSpecificIkeaMotionSensor",
        ID: 0xfc81,
        manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.IKEA_OF_SWEDEN,
        attributes: {
            onOnlyWhenDark: { name: "onOnlyWhenDark", ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN, write: true },
            onTime: { name: "onTime", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true },
        },
        commands: {},
        commandsResponse: {},
    });
}
function ikeaMotionSensorTriggerMode() {
    return m.enumLookup({
        name: "lux_value",
...
function ikeaMotionSensorOnDuration() {
    return m.numeric({
        name: "timer",
        cluster: "manuSpecificIkeaMotionSensor",
        attribute: "onTime",
...
function addCustomClusterTradfriButton() {
    return m.deviceAddCustomCluster("tradfriButton", {
        ...
        attributes: {},
        commands: {
            action1: { name: "action1", ID: 0x01, parameters: [{ name: "data", type: zigbee_herdsman_1.Zcl.DataType.UINT8, max: 0xff }] },
            action2: { name: "action2", ID: 0x02, parameters: [{ name: "data", type: zigbee_herdsman_1.Zcl.DataType.UINT8, max: 0xff }] },
            action3: { name: "action3", ID: 0x03, parameters: [{ name: "data", type: zigbee_herdsman_1.Zcl.DataType.UINT8, max: 0xff }] },
            action4: { name: "action4", ID: 0x04, parameters: [{ name: "data", type: zigbee_herdsman_1.Zcl.DataType.UINT8, max: 0xff }] },
            action6: { name: "action6", ID: 0x06, parameters: [{ name: "data", type: zigbee_herdsman_1.Zcl.DataType.UINT8, max: 0xff }] },
        },
        commandsResponse: {},
    });
}
function addIkeaGenScenesCluster() {
    return m.deviceAddCustomCluster("genScenes", {
        name: "genScenes",
        ID: zigbee_herdsman_1.Zcl.Clusters.genScenes.ID,
        attributes: {},
        commands: {
            tradfriArrowSingle: {
                ...
                ID: 0x07,
                parameters: [
                    { name: "value", type: zigbee_herdsman_1.Zcl.DataType.UINT16, max: 0xffff },
                    { name: "value2", type: zigbee_herdsman_1.Zcl.DataType.UINT16, max: 0xffff },
                ],
            },
            tradfriArrowHold: { name: "tradfriArrowHold", ID: 0x08, parameters: [{ name: "value", type: zigbee_herdsman_1.Zcl.DataType.UINT16, max: 0xffff }] },
            tradfriArrowRelease: { name: "tradfriArrowRelease", ID: 0x09, parameters: [{ name: "value", type: zigbee_herdsman_1.Zcl.DataType.UINT16, max: 0xffff }] },
        },
        commandsResponse: {},
    });
}
const unfreezeMechanisms = {
    ...
    moveColorTemp: async (entity) => {
        await entity.command("lightingColorCtrl", "moveColorTemp", { rate: 1, movemode: 0, minimum: 0, maximum: 600, optionsMask: 0, optionsOverride: 0 }, {});
    },
    // WS lights:
...
exports.ikeaModernExtend = {
    smartPlugChildLock: (args) => {
        ...
        const result = m.binary({
            ...
            zigbeeCommandOptions: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.IKEA_OF_SWEDEN },
        });
        return result;
    },
    smartPlugLedEnable: (args) => {
        ...
        const result = m.binary({
            name: resultName,
            cluster: "manuSpecificIkeaSmartPlug",
            attribute: { ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN },
            entityCategory: "config",
            valueOff: ["FALSE", 0x00],
            valueOn: ["TRUE", 0x01],
            description: resultDescription,
        ...
        result.exposes = [
            (device, options) => {
                if (!(0, utils_1.isDummyDevice)(device) &&
                    ...
                    (0, semver_1.gte)(device.softwareBuildID, "2.4.25")) {
                    return [(0, exposes_1.binary)(resultName, exposes_1.access.ALL, "TRUE", "FALSE").withDescription(resultDescription).withCategory("config")];
                }
                return [
                    (0, exposes_1.binary)(resultName, exposes_1.access.ALL, "TRUE", "FALSE")
     ...
     */
    handleAppVersionReadRequest: () => {
        const onEvent = [
            (event) => {
                if (event.type === "start") {
                    event.data.device.customReadResponse = (frame, endpoint) => {
                        if (frame.isCluster("genBasic") &&
                            frame.payload.some((i) => i.attrId === zigbee_herdsman_1.Zcl.Clusters.genBasic.attributes.appVersion.ID)) {
                            endpoint.readResponse("genBasic", frame.header.transactionSequenceNumber, { appVersion: 99 }).catch((e) => {
                                logger_1.logger.warning(`Custom appVersion response failed for '${event.data.device.ieeeAddr}': ${e}`, NS);
                            });
                            return true;
                        }
                        return false;
