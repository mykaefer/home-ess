  ...
  return `        <form action="/heizung/raum/${room.id}" method="POST" class="hz-settings">
          <div class="dialog-section">
            ...
            <div class="dialog-grid dialog-grid--two">
              ...
              <label class="field-block condition-topic-field"><span>Boost (optional)</span><span class="field-hint">Boost bleibt bidirektional synchron; aktiv heizt der Raum unabhängig von der Soll-Temperatur mit maximaler Leistung</span><input name="boostTopic" value="${escapeHtml(room.boostTopic)}" data-state-picker data-state-picker-writable autocomplete="off" placeholder="State auswählen…"></label>
            </div>
          </div>
          <div class="dialog-section">
