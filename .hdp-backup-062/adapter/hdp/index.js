...
const DEVICE_TYPES = Object.freeze(['percentage_indicator', 'argb_output', 'binary_io', 'sensors']);
...
function hasBinaryIo(device) {
  return isBinaryDevice(device) || isArgbDevice(device)
    || (isSensorDevice(device) && device.hardwareConfig
...
function createHdpAdapter(host, dependencies = {}) {
  ...
  function onDiscovered(found) {
    ...
    if (local) {
      ...
      if (found.runtimeMismatch) {
        local.lastError = `[UNSUPPORTED_RUNTIME_PROFILE] Gerät meldet ${found.runtimeProfile}; unterstützt werden pixel-timeline-v1, binary-io-v1 und sensor-reading-v1.`;
  ...
  async function pair(deviceId) {
    ...
    if (found.runtimeMismatch) {
      throw Object.assign(new Error(`Runtime-Profil ${found.runtimeProfile} ist inkompatibel; unterstützt werden pixel-timeline-v1, binary-io-v1 und sensor-reading-v1.`), {
...
module.exports._test = {
  ...
  deviceTypeOf, isBinaryDevice, isArgbDevice, isSensorDevice,
